...
public class ProprietarioActivity extends Activity {
    ...
    //private Button btnSalvar; DELETAR
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //btnSalvar = (Button)findViewById(R.id.btnSalvarProprietario); DELETAR
        ...
        imgSalvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editTelefone = (EditText) findViewById(R.id.edtProprietario);
                String resultado;
